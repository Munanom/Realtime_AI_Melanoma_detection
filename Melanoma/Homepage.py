...
if not firebase_admin._apps:
    ...
    cred = credentials.Certificate('/Users/munanuman/Desktop/Realtime_AI_Melanoma_detection/Melanoma/introtosfe-035c966fdaea.json')
    firebase_admin.initialize_app(cred)

def app():
    st.title('Welcome to Menanoma_AI')
